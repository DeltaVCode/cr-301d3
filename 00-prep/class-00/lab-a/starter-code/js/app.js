...
function displayPics(){
  ...
  // The error was thrown on the console.log(rando) due to the fact that the let declaration for rando is limited in scope to block, statement, or expression.
  // The console.log(rando) being outside of the function where let rando was declared meant that it could not find a deffinition of rando.
